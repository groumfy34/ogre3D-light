...
if(ON)
    ...
    if(TRUE)
        ...
        list(APPEND OGRE_Bites_LIBRARIES /usr/lib64/libSDL2main.a;/usr/lib64/libSDL2.so;-lpthread)
        
        list(APPEND OGRE_INCLUDE_DIRS /usr/include/SDL2)
        list(APPEND OGRE_LIBRARIES /usr/lib64/libSDL2main.a;/usr/lib64/libSDL2.so;-lpthread)
    endif()
endif()
if(ON)
